    ...
    <section className="mt-[-500px]">
      ...
      <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72">
        <CardContainer className="inter-var">
          <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] w-full 
        ...
        <CardContainer className="inter-var">
          ...
          dark:bg-black dark:border-[#E2CBFF] border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
            ...
            <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                For power users who need more advanced features and higher limits.
                <ul className="my-4 flex flex-col gap-2">
                  <li className="flex items-center gap-2">
        ...
        <CardContainer className="inter-var">
          ...
          dark:bg-black dark:border-[#E2CBFF] border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
            ...
            <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                For businesses that need custom solutions and dedicated support.
                <ul className="my-4 flex flex-col gap-2">
                  <li className="flex items-center gap-2">
                    <CheckIcon />Unlimited automations
                  </li>
